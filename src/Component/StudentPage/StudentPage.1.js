        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            <Container>
              ...
              <Button id='rightbtn' name="student" size="md" color="danger" onClick={this.update} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" onClick={this.reload}>重整reload </Button>
            </Container>
          </TabPane>
          ...
          <TabPane tabId="2">
            ...
            <Container>
              ...
              <Button id='rightbtn' size="md" color="danger" name='children_detail' onClick={this.update} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" name='children_detail' onClick={this.reload} >重整reload</Button>
            </Container>
          </TabPane>
          <TabPane tabId="3">
            <Container><Form>
              ...
              <Button id='rightbtn' size="md" color="danger" name='family_background' onClick={this.update} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" name='family_background' onClick={this.reload} >重整reload</Button>
            </Container>
          </TabPane>
          <TabPane tabId="4">
            <Container><Form>
              ...
              <Button id='rightbtn' size="md" color="danger" name='education_background' onClick={this.update.bind(this)} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" onClick={this.reload} >重整reload</Button>
            </Container>
          </TabPane>
          <TabPane tabId="5">
            <Container><Form>
              ...
              <Button id='rightbtn' size="md" color="danger" name='experience_working_abroad' onClick={this.update} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" onClick={this.reload} >重整reload</Button>
            </Container>
          </TabPane>
          ...
          <TabPane tabId="6">
            <Container><Form>
              ...
              <Button id='rightbtn' size="md" color="danger" name='local_employment' onClick={this.update} >修改UPDATE </Button>
              <Button id='leftbtn' size="md" color="success" onClick={this.reload} >重整reload</Button>
            </Container>
          </TabPane>
