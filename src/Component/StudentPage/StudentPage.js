...
export default class StudentPage extends Component {
  ...
  handleChangeId(event) {
    ...
    this.goTo('StudentPage/' + event.target.value)
    this.setState({
      student: {
        reference_no: this.props.id,
        jobtype: '',
              ...
              <Form>
                <FormGroup row inline>
                  ...
                  <Col xs="3" >
                    ...
                    <Input type="select" placeholder={'reference_no'} name="reference_no" onChange={this.handleChangeId} value={this.state.student.reference_no} id='input'>
                ...
                <FormGroup Row>
                  <Col>
                    ...
                    <Input bsSize="sm" id='input' type="select" name="married_status" onChange={this.handleChange} value={this.state.student.married_status} >
                ...
                <FormGroup>
                  <Col>
                    ...
                    <Input bsSize="sm" id='input' type='select' name="passport" onChange={this.handleChange} value={this.state.student.passport}>
                      <option value={'no'}>{'暫無 no'}</option>
                      <option value={'processing'}>{'辦理中 processing'}</option>
                      <option value={'ok'}>{'完成 ok'}</option>
                    </Input>
                ...
                <FormGroup>
                  <Col>
                    ...
                    <Input bsSize="sm" id='input' type='select' name="unified" onChange={this.handleChange} value={this.state.student.unified} >
                      <option value={'no'}>{'暫無 no'}</option>
                      <option value={'processing'}>{'辦理中 processing'}</option>
                      <option value={'ok'}>{'完成 ok'}</option>
                    </Input>
